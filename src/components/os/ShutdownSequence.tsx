...
const ShutdownSequence: React.FC<ShutdownSequenceProps> = ({
    ...
    Connecting to KYOS01/13:2026.${_F}.${_F}.${_F}
    |
    Established connection to KY0S01/13:2026, attempting data transfer.
    |
    ${_F}
    ...
    |(KYOS01/13:202:60099) [DEP_ANALYTICS_SERVER_ON_AFTER_SETUP_MIDDLEWARE] InvalidFormatting: 'onAnalyticsConversion' option received invalid parameters. Please contact a server administrator to resolve the issue.|
    ${_F}
    |(KYOS01/13:202:60099) [SOCKET_FAILED_TO_RESPOND] Connection Refused: Reconnecting... [${getTime()}:00]|
    |(KYOS01/13:202:60099) [SOCKET_FAILED_TO_RESPOND] Connection Refused: Reconnecting... [${getTime()}:01]
    (KYOS01/13:202:60099) [SOCKET_FAILED_TO_RESPOND] Connection Refused: Reconnecting... [${getTime()}:03]
    (KYOS01/13:202:60099) [SOCKET_FAILED_TO_RESPOND] Connection Refused: Reconnecting... [${getTime()}:05]
    (KYOS01/13:202:60099) [SOCKET_FAILED_TO_RESPOND] Connection Refused: Reconnecting... [${getTime()}:08]
    (KYOS01/13:202:60099) [SOCKET_FAILED_TO_RESPOND] Connection Refused: Reconnecting... [${getTime()}:12]
    (KYOS01/13:202:60099) [SOCKET_FAILED_TO_RESPOND] Connection Refused: Reconnecting... [${getTime()}:14]
    FATAL ERROR: (KYOS01/13:202:60099) Server became unresponsive and the transfer failed. Unable to shutdown computer. 
    |
    ...
    You can check out my Showcase, play Krishdle... but all you wanna do is shut the computer down.
    ${_L}
    |Goodbye Again!|
    ${_M}
