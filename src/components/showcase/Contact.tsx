...
import leetcodeIcon from '../../assets/pictures/contact-leetcode.png';
    ...
    async function submitForm() {
        ...
        try {
            ...
            const res = await fetch(
                'https://REPLACE-WITH-PRODUCTION-API-URL/api/contact',
                {
                    method: 'POST',
                    headers: {
        ...
        <div className="site-page-content">
            <div style={styles.header}>
                ...
                <div style={styles.socials}>
                    <SocialBox
                        icon={ghIcon}
                        link={'https://github.com/krshydv'}
                    />
                    <SocialBox
                        icon={inIcon}
                        link={'https://linkedin.com/in/krshydv'}
                    />
                    <SocialBox
                        icon={leetcodeIcon}
                        link={'https://leetcode.com/u/krshydv'}
                    />
                </div>
            </div>
            <div className="text-block">
                <p>
                    I'm a Software Engineer currently pursuing my CS
                    Engineering degree, so if you have any opportunities,
                    feel free to reach out - I would love to chat! You can
                    reach me via my personal email, or fill out the form
                    below!
                </p>
                <br />
                <p>
